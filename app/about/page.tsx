        ...
        <article className="prose prose-lg max-w-none dark:prose-invert">
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              I&apos;m Prateek Srivastava, a passionate Software Developer with
              over 3 years of professional experience in building scalable web
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              At Amino Technology Limited, I&apos;ve been instrumental in
              developing reusable Angular components that reduced development
              time by 40% and building payment gateway infrastructure handling
              1000+ daily transactions with 99.9% uptime. I&apos;ve also
              designed company websites using Next.js, achieving 95+ Lighthouse
              performance scores and improving page load speeds by 60%.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              maintainable code and implementing best practices that improve
              both developer experience and end-user satisfaction. My work
              consistently focuses on performance optimization, security, and
              scalability.
            </p>
          </section>
